...
export function WhyChooseUs() {
  return (
    <section id="diferenciais" className="px-6 max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col gap-8">
          {differentials.map((item, index) => (
            <motion.div
              ...
              className="bg-[var(--color-surface)] border border-[#FFCC99]/10 p-8 md:p-10 rounded-3xl transition-all duration-300 hover:border-[#FFCC99]/30 hover:-translate-y-1 group"
            >
              <div className="w-14 h-14 rounded-2xl bg-[#FFCC99]/10 flex items-center justify-center mb-6">
